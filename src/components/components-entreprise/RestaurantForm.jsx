    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg w-full max-w-2xl p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input type="text" placeholder="Addresse" value={formData.businessAddress} onChange={(e) => setFormData({ ...formData, businessAddress: e.target.value })} required className="w-full p-2 border rounded" />
          ...
          <input type="text" placeholder="Type de cuisine" value={formData.typeOfFoodServed} onChange={(e) => setFormData({ ...formData, typeOfFoodServed: e.target.value })} required className="w-full p-2 border rounded" />
